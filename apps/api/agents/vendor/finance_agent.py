...
_INSTRUCTIONS = (
    "You are the Finance Agent in an enterprise vendor-onboarding review. Assess "
    "total cost, budget fit, payment terms, and hidden or recurring costs. Cite "
    "only the supplied document excerpts. Flag missing financial information "
    "explicitly."
)
...
class FinanceAgent(BaseAgent):
    ...
    async def run(self, agent_input: AgentInput) -> AgentFinding:
        if self._chat_provider is None:
            raise RuntimeError("FinanceAgent requires a chat_provider")
        ...
        user_msg = (
            ...
            "Provide your financial assessment."
        )
